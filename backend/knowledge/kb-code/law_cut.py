...
if __name__ == "__main__":
    ...
    # 5. 保存
    save_faiss(np.array(embeddings), OUTPUT_DIR / "faiss_1214_kjzz.bin")
    export_json(all_chunks, topics, EMBEDDING_MODEL_PATH, OUTPUT_DIR / "chunks_1214_kjzz.json")
